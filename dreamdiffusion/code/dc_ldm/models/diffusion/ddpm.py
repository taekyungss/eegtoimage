...
class LatentDiffusion(DDPM):
    ...
    @torch.no_grad()
    def get_input(self, batch, k=1, return_first_stage_outputs=False, force_c_encode=False, cond_key=None, return_original_cond=False, bs=None):
    ...
    @torch.no_grad()
    # 앞에서 압축시킨 ddim 을 통한 sampling -> 잠재백터를 다시 이미지로 decoding시키는 코드
    ...
    def p_losses(self, x_start, cond, t, noise=None):
        ...
        # vlb는  Variational Lower Bound loss
