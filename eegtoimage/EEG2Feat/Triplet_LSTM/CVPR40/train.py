...
if __name__ == '__main__':
    ...
    # 여기서 직접 data를 불러오는 구조 (eeg_imagenet40_cvpr_2017_raw/train 안에 들어있는 npy파일들 하나하나 불러오면서 저장)
    ...
    # cosine similiarity 기준으로 거리계산
    # Negative pairs는  (hardest positive pair  - margin ) 유사도가 큰 경우 선택
    # Positive paris는  (hardest Negative pair  - margin ) 유사도가 낮은 경우 선택
